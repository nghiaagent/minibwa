...
\subsection{Seeding, chaining and base alignment}
...
This chaining algorithm is more robust than BWA-MEM's heuristic.
Minibwa uses the same core routines in minimap2 for base alignment.
In comparison to BWA-MEM, minimap2 and minibwa test ungapped alignment before performing full dynamic programming.
This speeds up short-read alignment.
...
\caption{Evaluating mapping accuracy on simulated data.}\label{fig:roc}
\end{figure*}
...
We used default option for Nanopore reads
